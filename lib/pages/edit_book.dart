...
class EditBook extends StatefulWidget {
  ...
  const EditBook(this.bookId, this.bookTitle, this.cover, this.bookPages,
      this.bookReleaseDate, this.bookLanguage,
      {super.key});
            ...
            builder: (context) => Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    initialValue:
                        bookId == 0 ? null : widget.bookPages.toString(),
                  ...
                  TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        bookReleaseDate = pickedDate.millisecondsSinceEpoch;
                        setState(() {
